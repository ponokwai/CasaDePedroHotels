<%@ Page Title="Update Meeting or Event Booking" Language="C#" MasterPageFile="~/Management/Management.Master" AutoEventWireup="true" CodeBehind="MEBookingDetail.aspx.cs" Inherits="CasaDePedro.Booking.MEBookingDetail" %>
                ...
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <p class="text-success">
                            <asp:Literal ID="ltlConfirmedBy" runat="server"></asp:Literal>
                        </p>
